...
<aside>
  <nav>
    <div class="logo">
      <a href="../Dashboard/dashboard.php"><img src="../../Images/icons/mainlogo.svg" alt="main logo" loading="lazy" /></a>
    </div>
    ...
    <div class="nav-list">
      <ul>
        ...
        <li class="list-row">
          <a href="../ControlPanel/controlpanel.php">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 icon">
              <path
